                ...
                <div className="card-body contacts_body">
                    <ul className="contacts">
                        ...
                        <li>
                            <div className="d-flex bd-highlight">
                                <div className="img_cont">
                                    <img src="https://img.freepik.com/premium-photo/happy-cartoon-character-kid-wearing-golf-clothes_41969-14007.jpg" className="rounded-circle user_img" />
                                    <span className="online_icon offline"></span>
                                </div>
                                <div className="user_info">
                        ...
                        <li>
                            <div className="d-flex bd-highlight">
                                <div className="img_cont">
                                    <img src="https://i.pinimg.com/originals/88/bb/6f/88bb6fb173be415dc3697b4147c3c48f.jpg" className="rounded-circle user_img" />
                                    <span className="online_icon offline"></span>
                                </div>
                                <div className="user_info">
                                    <span>Riley Stephenson</span>
                                    <p>Riley left 50 mins ago</p>
                                </div>
                            </div>
                        </li>
                    </ul>
